...
public class SynchronizedTabulatedFunctionTest {
    ...
    public void testIterator() {
        ...
        assertEquals(i, synchronizedLLF.getCount());
        assertEquals(j, synchronizedLLF.getCount());
         i =0;
         j =0;
        ...
        assertEquals(i, synchronizedATF.getCount());
        assertEquals(j, synchronizedATF.getCount());
    }
